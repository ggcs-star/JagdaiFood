...
const SampleCard = ({ item, handler }) => {
  return (
    <div className="px-5">
      <div className="group relative flex flex-col bg-[#262626] rounded-[20px] lg:w-[400px] h-[460px] text-gray-300 overflow-hidden mx-auto transition-all duration-500">
        
        <div
          className="absolute bottom-0 h-40 w-full rounded-t-full blur-2xl z-0"
          style={{ background: bgColors[item?.id - 1] }}
        />
        ...
        <div className="pt-6 z-10 text-center px-6">
          ...
          <p className="pt-3">{item?.desc?.substring(0, 100)}...</p>
        </div>
        ...
        <div className="mt-auto pb-6 z-10 flex justify-center px-4">
          <img
            src={item?.image}
            alt="card"
            className="w-full max-h-[240px] object-contain transition-transform duration-500 relative z-20"
          />
        </div>
