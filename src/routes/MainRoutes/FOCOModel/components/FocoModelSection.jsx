...
export default function FocoModelSection() {
  return (
<section className="w-full py-8 lg:py-16 px-[16px] sm:px-[20px]  ">
  <div className="max-w-[1200px] mx-auto rounded-[24px] bg-[#262626] px-[20px] sm:px-[40px] md:px-[60px] py-[40px] md:py-[80px] relative overflow-hidden">    
