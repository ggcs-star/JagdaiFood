...
export default function FofoModelSection() {
  return (
    <section className="w-full flex justify-center px-3">
      <div className="relative w-full max-w-7xl rounded-[24px] overflow-hidden text-center pt-[60px] md:pt-[80px] pb-[20px] lg:pb-[40px] bg-gradient-to-b from-[#2b2b2b] to-[#1f1f1f] backdrop-blur-[30px]">
        {" "}
