...
export default function WhiteLabelProfitCard() {
  return (
    <div className="w-full max-w-[1100px] md:h-[427px] mx-auto mt-[40px] rounded-[24px] bg-[#5A5A5A] pt-[40px] pb-[40px] px-[20px] sm:px-[40px] md:px-[60px]">
        ...
        <div className="w-full md:w-[426px]">
          ...
          <div className="space-y-[28px]">
            <div className="flex items-center gap-[16px]">
              ...
              <p className="text-white font-bricolageSemiBold text-[20px] leading-[40px] md:whitespace-nowrap">
                300 daily orders
              </p>
            </div>
