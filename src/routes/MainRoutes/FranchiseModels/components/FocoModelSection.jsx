...
export default function FocoModelSection() {
  return (
<section className="w-full px-[16px] sm:px-[20px]">
  <div className="max-w-[1200px] mx-auto mt-[40px] rounded-[24px] bg-[#262626] px-[20px] sm:px-[40px] md:px-[60px] py-[60px] md:py-[80px] relative overflow-hidden">    
