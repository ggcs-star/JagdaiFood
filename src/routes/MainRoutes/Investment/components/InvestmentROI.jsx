...
export default function InvestmentROI() {
  return (
    <section className="bg-black text-white py-8 pt-24">
      <div className="max-w-4xl mx-auto text-center px-3 lg:px-6">
        ...
        <p className="text-gray-300 text-lg leading-relaxed max-w-3xl mx-auto">
          Jagdai Foods operates multiple franchise formats — each with clearly
          defined investment, breakeven timeline, and profit structure.
          <br />
