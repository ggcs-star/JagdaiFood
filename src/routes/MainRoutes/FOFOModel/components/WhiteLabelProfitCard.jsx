    ...
    <div className="lg:w-full lg:max-w-[1100px] mx-3 md:h-[427px] lg:mx-auto mt-[40px] rounded-[24px] bg-[#5A5A5A] pt-[40px] pb-[40px] px-[20px] sm:px-[40px] md:px-[60px] box-border">
      ...
      <div className="flex flex-col md:flex-row md:items-start">
        ...
        <div className="w-full md:w-[426px]">
          <p className="text-[#FDBD5B] font-bricolageSemiBold text-[20px] mb-[24px] text-left">
            Assuming
          </p>
          ...
          <div className="space-y-[28px]">
            ...
            <div className="flex items-center gap-[16px]">
              ...
              <p className="flex-1 text-left text-white font-bricolageSemiBold text-[16px] sm:text-[18px] md:text-[20px] leading-[24px] md:leading-[32px]">
                300 daily orders
              </p>
            </div>
