...
export default function FranchiseCTA() {
  ...
  className="flex items-center justify-center gap-2 w-full sm:w-auto bg-[#2a2a2a] text-white px-4 sm:px-5 lg:px-6 py-3 rounded-lg font-medium hover:opacity-90 transition"
>
  <FaWhatsapp size={20} />
