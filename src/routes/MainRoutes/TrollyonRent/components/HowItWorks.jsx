...
// import teamIcon from "../../../../assets/brands/team.svg";

// const HowItWorks = () => {
//   const data = [
//     "You get a fully branded,\nready-to-operate food trolley",
//     "Choose where you operate: offices, colleges,markets,\n societies, events, nightlife areas",
//     "Choose when you operate: breakfast,\nlunch, evening snacks, late night",
//     "Sell offline and online : Also sell on Zomato,\nSwiggy & Jagods Food Delivery Apps",
//     "No matter how much you earn, your\npayment stays ₹18,000/month",
//     "Your profit = 100% yours",
//   ];
...
//       {/* CONTAINER */}
//       <div className="max-w-[1440px] mx-auto px-[120px] pt-[20px] pb-[140px]">

//         {/* HEADING */}
//         <div className="text-center mb-[80px]">
//           <h2 className="text-[40px] leading-[48px] font-semibold font-bricolageBold">
//             How It Works?
//           </h2>

//           <p className="text-[#9ca3af] text-[16px] mt-[10px] font-bricolage">
//             A fixed-cost, high-profit model with unlimited earning potential.
//           </p>
//         </div>

//         {/* GRID (IMPORTANT FIX) */}
//         <div className="grid grid-cols-2 gap-x-[160px] gap-y-[60px]">

//           {data.map((item, index) => (
//             <div key={index} className="flex items-start gap-[24px]">
              
//               {/* ICON */}
//               <div className="min-w-[56px] h-[56px] rounded-[14px] border border-[#FDBD5B] flex items-center justify-center bg-[#2A2416]">
//                 <img src={teamIcon} alt="" className="w-[28px] h-[28px]" />
//               </div>

//               {/* TEXT */}
//               <p className="text-[18px] leading-[28px] text-[#E5E7EB] whitespace-pre-line font-bricolage max-w-[460px]">
//                 {item}
//               </p>
    ...
    <div className="w-full bg-black text-white">
      ...
      <div className="max-w-[1440px] mx-auto px-[20px] md:px-[60px] lg:px-[120px] pt-[40px] md:pt-[60px] lg:pt-[20px] pb-[80px] md:pb-[100px] lg:pb-[140px]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-[40px] md:gap-x-[80px] lg:gap-x-[160px] gap-y-[30px] md:gap-y-[40px] lg:gap-y-[60px]">
          ...
          {data.map((item, index) => (
            <div key={index} className="flex items-start gap-[16px] md:gap-[20px] lg:gap-[24px]">
              
              {/* ICON BOX */}
              <div className="min-w-[48px] md:min-w-[52px] lg:min-w-[56px] h-[48px] md:h-[52px] lg:h-[56px] rounded-[12px] md:rounded-[14px] border border-[#FDBD5B] flex items-center justify-center bg-[#2A2416]">
                <img src={item.icon} alt="" className="w-[24px] md:w-[28px] lg:w-[32px] h-[24px] md:h-[28px] lg:h-[32px]" />
              </div>
