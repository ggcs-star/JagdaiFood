...
import React from "react";
import check from "../../../../assets/franchisemodels/check.svg";
import brandsImg from "../../../../assets/franchisemodels/brandscroll.png";
...
export default function MultiBrandEcosystem() {
  return (
    ...
    >
      {/* TOP CONTENT */}
      <div>
        <h3 className="text-white text-[24px] md:text-[30px] mb-[16px] font-bricolageSemiBold">
          A Multi-Brand Franchise Ecosystem
        </h3>

        <p className="text-[#D1D1D1] mb-[20px]">
        ...
        <div className="space-y-[12px] mb-[20px]">
          {[
            ...
            <div key={i} className="flex items-start gap-[10px]">
              <img src={check} className="w-[16px] mt-[3px]" />
      ...
      <div className="relative mt-[60px] rounded-[16px] border border-[#3a3a3a] p-[10px]">
        {/* SCROLL AREA */}
        <div className="h-[300px] overflow-x-auto overflow-y-hidden hide-scrollbar scroll-smooth">
          <img
            src={brandsImg}
            alt="Brands"
            className="h-full min-w-[900px] object-contain"
          />
        </div>

        {/* LEFT FADE */}
        <div className="pointer-events-none absolute left-0 top-0 h-full w-[40px] bg-gradient-to-r from-[#262626] to-transparent rounded-l-[16px]" />

        {/* RIGHT FADE */}
        <div className="pointer-events-none absolute right-0 top-0 h-full w-[40px] bg-gradient-to-l from-[#262626] to-transparent rounded-r-[16px]" />
      </div>
    </div>
  );
}
