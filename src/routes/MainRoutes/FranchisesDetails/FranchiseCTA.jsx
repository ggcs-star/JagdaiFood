...
Franchise Journey            </h2>
  ...
  className="flex items-center justify-center gap-2 cursor-pointer bg-[#2a2a2a] text-white px-2 lg:px-6 py-3 rounded-lg font-medium hover:opacity-90 transition"
>
  <FaWhatsapp size={20} />
