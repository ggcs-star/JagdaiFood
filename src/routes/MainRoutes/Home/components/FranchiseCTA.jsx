...
>
  ...
  <span>Schedule Consultation</span>
            ...
            <a
              ...
              className="cursor-pointer w-full sm:w-auto bg-white text-black px-4 sm:px-5 lg:px-6 py-3 rounded-lg font-medium hover:opacity-90 transition text-center"
            >
              Download PPT
            </a>
