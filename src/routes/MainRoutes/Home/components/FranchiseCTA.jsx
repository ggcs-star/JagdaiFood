    ...
    <section className="bg-black py-4 sm:py-6 lg:py-8">
      <Container>
        ...
        <div className="rounded-[20px] sm:rounded-[30px] bg-gradient-to-r from-[#6BC07F] to-[#F2B44F] px-3 sm:px-4 lg:px-8 py-5 sm:py-6 lg:py-8 text-center">
          ...
          {/* Buttons */}
          <div className="text-xs sm:text-sm lg:text-lg flex flex-col sm:flex-row justify-center items-center gap-3 sm:gap-4">
            
            <button
              onClick={() => navigate("/contact")}
              className="w-full sm:w-auto bg-[#2a2a2a] text-white px-4 sm:px-5 lg:px-6 py-3 rounded-lg font-medium hover:opacity-90 transition"
            >
              Schedule Consultation
            </button>

            <button className="w-full sm:w-auto bg-white text-black px-4 sm:px-5 lg:px-6 py-3 rounded-lg font-medium hover:opacity-90 transition">
