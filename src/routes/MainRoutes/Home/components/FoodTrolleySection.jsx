...
export default function FoodTrolleyFranchise() {
  return (
    <div className="bg-black flex items-center justify-center px-4 py-6 ">
      {/* MAIN CARD */}
      <div className="w-full md:h-[650px] h-[400px] max-w-7xl rounded-3xl bg-[#262626] p-8 md:p-6 border border-gray-800 shadow-[0_0_60px_rgba(0,0,0,0.8)] relative overflow-hidden">
        <div
