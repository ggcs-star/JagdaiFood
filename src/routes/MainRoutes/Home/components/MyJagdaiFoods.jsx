  ...
  return (
    <section className="bg-black py-20">
      <Container>
        ...
        {/* Main Card */}
        <div className="relative rounded-[28px] overflow-hidden bg-gradient-to-r from-[#6BC07F] to-[#F2B44F] p-10 md:p-14">
          ...
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            ...
            <div className="relative">
              ...
              <h2 className="font-bricolageBold text-3xl md:text-4xl text-black mb-10 leading-tight">
